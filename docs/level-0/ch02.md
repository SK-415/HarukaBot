...
本文写于2021/3/19，从此处开始均不可避免的存在时效性，请各位自行鉴别
...
3. [go-cqhttp](https://github.com/Mrs4s/go-cqhttp/releases/download/v0.9.40-fix4/go-cqhttp-v0.9.40-fix4-windows-amd64.exe)（此客户端版本为v0.9.40-fix4）

::: details go-cqhttp下载的太慢了/github被墙了没法下载？

​	[go-cqhttp fastgit加速](https://hub.fastgit.org/Mrs4s/go-cqhttp/releases/download/v0.9.40-fix4/go-cqhttp-v0.9.40-fix4-windows-amd64.exe)
